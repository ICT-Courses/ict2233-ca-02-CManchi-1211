...
    html_url: "https://github.com/CManchi-1211/IPMS"
  },
  {
    id: 2,
...
    html_url: "https://github.com/CManchi-1211/QuoteGallery"
  },
{
    id: 3,
...
    html_url: "https://github.com/CManchi-1211/SilkShield-GroupProject"
  }
];
        ...
        <table className="w-full border-collapse border-separate border-spacing-x-25 border-spacing-y-12">
          <tbody>
            ...
            {projects.reduce((rows, project, index) => {
              ...
              <tr key={rowIndex}>
                {row.map((project) => (
                  <td key={project.id} className="p-4 align-top text-center">
